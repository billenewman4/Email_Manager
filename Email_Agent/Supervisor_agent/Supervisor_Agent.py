...
class SupervisorAgent:
    def __init__(self, openai_api_key: str):
        ...
        self.evaluation_prompt = """You are a supervisor evaluating an email draft. Your job is to determine if the email needs revision, needs more research, or is ready to send.
        ...
        3. Is it personalized and specific enough?
