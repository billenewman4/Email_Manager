...
if __name__ == "__main__":
    ...
    test_contact = Contact({
        ...
        "Job Title": "Senior Product Manager, AI/ML Division",
        "Company Name": "TechCorp Solutions",
        "Company Description": "Leading AI/ML enterprise solutions provider",
    ...
    test_sender = Sender(
        ...
        career_interest="AI/ML Product Management and Technical Product Development",
        key_accomplishments=[
    ...
    initial_state = {
        "input": "Draft an email to connect about AI/ML product management opportunities and discuss TechCorp's recent work in enterprise AI solutions",
        "workers_called": [],
        "messages": [],
